...
<div class="breadcrumb-area bg-img pt-230 pb-152"
	style="background-image: url(${pageContext.request.contextPath }/resources/img/banner/breadcrumb-4.jpg);">
	<div class="container">
	...
	<div class="wrap-sidebar">
		...
		<div class="summary-info-all">
			<div class="summary-logo">
				<a href="index.html"> <img src="assets/img/logo/logo-3.png"
					alt="">
				</a>
			</div>
					...
					<div class="login-regi-wrapper">
						<div class="login-register-tab-list nav">
							<a class="active" data-toggle="tab" href="#login">
								<h4>Log In</h4>
							</a> <a data-toggle="tab" href="#register">
								<h4>register</h4>
							</a>
						</div>
								...
								<div class="login-register-form">
									...
									<div class="login-social-wrap">
										...
										<div class="login-social-btn">
											<a class="facebook" href="#"><i class="ti-facebook"></i>
												Facebook</a> <a class="twitter" href="#"><i
												class="ti-twitter-alt"></i> Twitter</a>
										</div>
									</div>
								</div>
							</div>
